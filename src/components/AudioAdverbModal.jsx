// AudioAdverbModal.jsx
import React, { useState, useEffect, useRef } from 'react';

const API_BASE_URL = 'https://learn-lng-new-client-lrqy.onrender.com/api';

export default function AudioAdverbModal({ isOpen, onClose, word, language, onAudioSaved }) {
  ...
  const loadExistingAudio = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/adverb-audio/${word.imageBase}/${language}`);
  ...
  const uploadAudio = async () => {
    ...
    try {
      ...
      const urlResponse = await fetch(`${API_BASE_URL}/adverb-audio/generate-upload-url`, {
        method: 'POST',
      ...
      const saveResponse = await fetch(`${API_BASE_URL}/adverb-audio/save`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          imageBase: word.imageBase,
